...
if __name__ == "__main__":
    ...
    def _show_welcome(self, win):
        ...
        page.set_title(_("Welcome to Snap L10n"))
        page.set_description(_("Track snap package translation status.\n\n✓ View translation coverage per snap\n✓ Filter by publisher and language"))
